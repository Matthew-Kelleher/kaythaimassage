...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Original Thai massage therapy in Kilkenny. 4.8★ rated. Call 085 749 6528." },
      ...
      { property: "og:description", content: "Original Thai massage therapy in Kilkenny. 4.8★ rated. Call 085 749 6528." },
      { name: "twitter:description", content: "Original Thai massage therapy in Kilkenny. 4.8★ rated. Call 085 749 6528." },
