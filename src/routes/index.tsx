...
function HomePage() {
  ...
  return (
    <div>
      {/* Hero */}
      <section id="hero" className="relative min-h-[100svh] flex items-center justify-center overflow-hidden bg-purple-deep">
        <div className="absolute inset-0">
          <img src={heroBg} alt="Kay Thai Massage" width={1080} height={1920} className="h-full w-full object-contain object-center" style={{ filter: "saturate(1.05)" }} />
          <div className="absolute inset-0 bg-gradient-to-b from-purple-deep/30 via-transparent to-purple-deep/70" />
        </div>
