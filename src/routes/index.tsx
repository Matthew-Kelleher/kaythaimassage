    ...
    <div>
      ...
      <section id="hero" className="relative min-h-[100svh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroBg} alt="Kay Thai Massage" width={1080} height={1920} className="h-full w-full object-cover object-[center_20%]" style={{ filter: "saturate(1.05)" }} />
          <div className="absolute inset-0 bg-gradient-to-b from-purple-deep/40 via-purple-deep/20 to-purple-deep/60" />
        </div>
