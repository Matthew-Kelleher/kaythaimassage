  ...
  return (
    <footer className="bg-purple-deep text-gold-light/70">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-16">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+353857496528" className="hover:text-gold transition-colors">085 749 6528</a>
              </div>
              <div className="flex items-center gap-3">
        ...
        <div className="mt-12 pt-8 border-t border-gold/10 flex flex-col items-center gap-5">
          <div className="flex items-center gap-5">
            <a href="https://www.facebook.com/people/Kay-Thai-massage/100067600275300/" target="_blank" rel="noopener noreferrer" className="text-gold-light/50 hover:text-gold transition-colors" aria-label="Facebook">
            ...
            <a href="https://www.instagram.com/kesornflynn" target="_blank" rel="noopener noreferrer" className="text-gold-light/50 hover:text-gold transition-colors" aria-label="Instagram">
            ...
            <a href="https://wa.me/353857496528" target="_blank" rel="noopener noreferrer" className="text-gold-light/50 hover:text-gold transition-colors" aria-label="WhatsApp">
          ...
          <p className="text-[10px] text-gold-light/20 mt-2">
            Created by{" "}
            <a href="https://kelleherwebdesign.com" target="_blank" rel="noopener noreferrer" className="hover:text-gold-light/40 transition-colors underline">
              KelleherWebDesign
            </a>
          </p>
        </div>
