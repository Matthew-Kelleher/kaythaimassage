      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="mt-12 pt-8 border-t border-gold/10 flex flex-col items-center gap-5">
          <div className="flex items-center gap-5">
            ...
            <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="text-gold-light/50 hover:text-gold transition-colors" aria-label="Instagram">
